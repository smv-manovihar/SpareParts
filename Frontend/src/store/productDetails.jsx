...
const ProductDetails = () => {
	...
	if (!product) return <div>Loading...</div>; // Show loading message while the data is being fetched
    ...
    <GridItem display="flex" flexDirection="column" alignItems="flex-start" justifyContent="center">
        ...
        <List spacing={1} mb={4} color={textColor}>
            {product.compatibility && product.compatibility.length > 0 ? (
                ...
                <Text color={textColor}>No compatibility information available.</Text>
            )}
        </List>
